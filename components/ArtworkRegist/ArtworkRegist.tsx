...
import { MdAttribution, MdOutlineDriveFolderUpload, MdOutlineColorLens, MdOutlineAddPhotoAlternate } from "react-icons/md";
    ...
    return (
        <div className="tab">
            ...
            <div className="tabBtns">
                <div className="take">
                    <div className="title"><AiOutlineDownload />다운로드 가능여부</div>
                ...
                <div className="take">
                    <div className="title"><AiOutlineShareAlt />공유 가능여부</div>
                    <div className="takeBox">
                ...
                <div className="take">
                    <div className="title"><MdAttribution />저작권 허용</div>
                    <div className="takeBox">
